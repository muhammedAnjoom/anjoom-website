...
const Footer = () => (
  <footer
    className=" md:w-full md:border-0  py-2 md:py-4 text-center text-slate-200 border border-emerald-400/30 shadow-xl backdrop-blur-2xl rounded-t-2xl rounded-b-none"
    style={{
