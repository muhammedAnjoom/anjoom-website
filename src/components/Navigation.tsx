        ...
        {isOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-slate-900/95 backdrop-blur-sm border-t border-slate-700">
            <div className="px-4 py-6 space-y-4">
              ...
              <a
                href="/resume.pdf"
                className="block border border-emerald-400 text-emerald-400 px-4 py-2 rounded text-center hover:bg-emerald-400 hover:text-slate-900 transition-all duration-200"
              >
                Resume
              </a>
            </div>
